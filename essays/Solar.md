...
Despite this optimization, the overall power demand remained extremely high, and the resulting battery system was still too large to be practical for a mobile AGV. Based on these insights, we ultimately made the decision to transition from an electrically driven suction system to a hydraulic solution.
