...
A key challenge was that Lagori discs could land:Flat on the ground, or Standing vertically on their curved edge
...
The pneumatic system was controlled using solenoid valves, specifically Janatics 5-port, 2-position valves, which regulated airflow to the actuators.To manage this system cleanly, I designed a dedicated ESP32-based control unit:
Designed a 2-layer PCB in Altium. Reduced wiring complexity and improved reliability
